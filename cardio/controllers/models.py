...
api.add_model(model_schemes.prediction.name, model_schemes.prediction)
...
class Model(Resource):
    @api.doc(description='Get model', id='get_model', params={'id': {'format': 'uuid'}})
    ...
    @api.doc(description='Delete model', id='delete_model', params={'id': {'format': 'uuid'}})
...
#     @api.expect(models_reqparsers.prediction_data, validate=True)
